...
export const VibeWidget = memo(({ vibeData, loading }: VibeWidgetProps) => {
  ...
  if (loading) {
    return (
      <div className="w-full max-w-sm rounded-[24px] border border-white/10 bg-black/40 backdrop-blur-xl p-4 md:rounded-[32px] md:border-white/20 md:bg-black/30 md:backdrop-blur-2xl md:p-5 md:shadow-2xl flex items-center justify-center min-h-[150px]">
  ...
  return (
    <div className="w-full max-w-sm rounded-[24px] border border-white/10 bg-black/40 backdrop-blur-xl p-4 md:rounded-[32px] md:border-white/20 md:bg-white/10 md:backdrop-blur-2xl md:px-5 md:pt-4 md:pb-5 md:shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] flex flex-col gap-4">
      {/* Header Tabs */}
